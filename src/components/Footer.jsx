    ...
    return (
      <footer className="py-10 text-center border-t border-white/10 bg-black relative z-10">
        ...
        <div className="flex justify-center gap-8 mb-6">
          ...
          <a href="https://www.instagram.com/matcom_nith/" className="text-gray-400 hover:text-neonPurple transition-colors hover:scale-110 transform duration-200">
              <Instagram size={24} />
          </a>
          <a href="https://www.linkedin.com/company/matcom-nith/posts/?feedView=all" className="text-gray-400 hover:text-neonBlue transition-colors hover:scale-110 transform duration-200">
              <Linkedin size={24} />
          </a>
